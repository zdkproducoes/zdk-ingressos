...
export default async function SuccessPage({ searchParams }: { searchParams: Promise<{ order?: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-surface-800 flex items-center justify-center px-4">
      <div className="max-w-md w-full rounded-xl bg-surface-700 border border-emerald-800/50 p-8 text-center">
        ...
        <div className="mt-6 flex flex-col gap-2">
          <Link href="/minhas-compras" className="rounded-lg bg-accent-400 hover:bg-accent-500 text-surface-800 font-semibold py-2.5 px-6 transition">Ver meus ingressos</Link>
