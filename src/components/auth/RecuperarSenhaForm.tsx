  ...
  if (sent) {
    return (
      <div className="space-y-4 text-center">
        ...
        <Link href="/login" className="block text-sm text-amber-sacode-400 hover:text-amber-sacode-300 underline pt-2">
          Voltar para o login
        </Link>
      </div>
    );
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <p className="text-center text-sm text-cream-400 pt-2">
        Lembrou a senha?{' '}
        <Link href="/login" className="text-amber-sacode-400 hover:text-amber-sacode-300 underline">
          Voltar para o login
        </Link>
      </p>
    </form>
