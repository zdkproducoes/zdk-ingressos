  ...
  return (
    <section id="ingressos" className="max-w-[700px] mx-auto px-5 pt-8 pb-20">
      ...
      <h2 className="font-display-bold text-[clamp(2rem,4.5vw,2.75rem)] text-cream-200 text-center mb-2">
        Ingressos <span className="text-amber-sacode-400">disponíveis</span>
      </h2>
      ...
      <div className="bg-gradient-to-br from-mauve-700 to-wine-700
                      border-2 border-amber-sacode-400 rounded-2xl p-8
                      relative overflow-hidden
                      shadow-[0_12px_36px_-12px_rgba(0,0,0,0.6)]">
        <div className="absolute top-0 left-0 right-0 h-[6px]
                        bg-gradient-to-r from-mauve-500 via-amber-sacode-400 to-mauve-500" />

        <div className="flex flex-wrap gap-2 mb-4">
          <span className="inline-block px-3 py-1 bg-wine-600
                           border border-mauve-500 text-cream-100
                           rounded text-[0.7rem] font-bold tracking-[0.1em] uppercase">
            <span className="inline-block mr-1.5 text-amber-sacode-300 animate-pulse">●</span>
            Vendendo agora
          </span>
          {isUrgent && (
            <span className="inline-block px-3 py-1 bg-amber-sacode-400 text-wine-900
                             rounded text-[0.7rem] font-bold tracking-[0.1em] uppercase">
              Quase esgotado
            </span>
          )}
        ...
        <div className="flex items-baseline gap-2 mb-7">
          ...
          <span className="font-display-bold text-[4rem] leading-none text-amber-sacode-400 tracking-tight">
            {lote.price}
          </span>
        ...
        {isUrgent && (
          <div className="bg-amber-sacode-400/10 border border-amber-sacode-500
                          rounded-[10px] px-4 py-3 mb-5
                          text-amber-sacode-300 font-semibold text-sm
        ...
        <div className="flex items-center justify-between bg-wine-900
                        border border-mauve-700 rounded-[10px] px-3.5 py-2.5 mb-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="w-9 h-9 bg-wine-800 text-amber-sacode-400
                         border border-mauve-600 rounded-lg
                         text-xl font-bold cursor-pointer
                         flex items-center justify-center transition-colors
                         hover:bg-wine-700 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              −
            </button>
        ...
        <div className="flex justify-between items-baseline py-3.5
                        border-y border-dashed border-mauve-600 mb-5">
          <span className="text-cream-300 text-[0.9375rem]">Total</span>
          <span className="font-display-bold text-2xl text-amber-sacode-400">
            R$ {totalFormatted}
          </span>
        </div>
        ...
        <button
          ...
          className="w-full bg-amber-sacode-400 text-wine-900
                     py-4 rounded-[10px]
                     font-display-bold text-xl tracking-wider uppercase
                     cursor-pointer transition-all duration-200
                     shadow-[0_4px_0_#A06D26]
                     hover:bg-amber-sacode-300 hover:-translate-y-0.5
