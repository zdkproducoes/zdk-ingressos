  ...
  return (
    <div className={proseClasses}>
      ...
      <p>
        ...
        dos dados compreenda o tratamento que será dado às suas informações
        pessoais e exerça plenamente seus direitos.
      </p>
      ...
      <ul>
        <li>
          <strong>&ldquo;Dado pessoal&rdquo;:</strong> informação relacionada
          a pessoa natural identificada ou identificável.
        </li>
        <li>
          <strong>&ldquo;Tratamento&rdquo;:</strong> toda operação realizada
          com dados pessoais, como coleta, classificação, utilização, acesso,
          reprodução, transmissão, armazenamento, eliminação.
        </li>
        <li>
        ...
        <li>
          ...
          jurídica a quem competem as decisões sobre o tratamento de dados
          pessoais.
        </li>
        <li>
          <strong>&ldquo;Operador&rdquo;:</strong> pessoa natural ou jurídica
          que realiza o tratamento de dados pessoais em nome do controlador.
        </li>
        <li>
          <strong>&ldquo;Encarregado&rdquo; (DPO):</strong> pessoa indicada
          pelo controlador para atuar como canal de comunicação entre o
          controlador, os titulares e a Autoridade Nacional de Proteção de
          Dados.
        </li>
      </ul>
      ...
      <div className="not-prose my-6 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr>
              <th className={tableHeadClass}>Papel</th>
              <th className={tableHeadClass}>Quem é</th>
              <th className={tableHeadClass}>Responsabilidade</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
              <td className={tableCellClass}>Encarregado (DPO)</td>
              <td className={tableCellClass}>
                Fernando Zedeque
                <br />
                <a
      ...
      <ul>
        ...
        <li>
          Registros de auditoria de ações sensíveis (alteração de cadastro,
          transferência de ingresso, etc.)
        </li>
      </ul>
      ...
      <p>
        ...
        armazenados ou processados pela Plataforma. Tais dados são fornecidos
        diretamente pelo titular ao Mercado Pago, provedor de meios de
        pagamento contratado pelo Controlador, sujeitando-se à política de
        privacidade do referido provedor.
      </p>
      ...
      <p>
        <strong>
          3.1.1. Execução do contrato de compra do ingresso (base legal: art.
          7º, V, LGPD):
        </strong>
      </p>
      <ul>
      ...
      <p>
        <strong>
          3.1.2. Cumprimento de obrigações legais e regulatórias (base legal:
          art. 7º, II, LGPD):
        </strong>
      </p>
      <ul>
        ...
        <li>
          Conservação de registros de operações conforme legislação aplicável
        </li>
      </ul>

      <p>
        <strong>
          3.1.3. Legítimo interesse do Controlador (base legal: art. 7º, IX,
          LGPD):
        </strong>
      </p>
      <ul>
        ...
        <li>
          Análise estatística agregada e anonimizada para melhoria do serviço
        </li>
      ...
      <p>
        ...
        com os seguintes terceiros, exclusivamente para as finalidades aqui
        declaradas:
      </p>
      ...
      <div className="not-prose my-6 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr>
              <th className={tableHeadClass}>Provedor</th>
              <th className={tableHeadClass}>Finalidade</th>
              <th className={tableHeadClass}>Localização dos dados</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className={tableCellClass}>Supabase</td>
              <td className={tableCellClass}>
            ...
            <tr>
              <td className={tableCellClass}>Vercel</td>
              <td className={tableCellClass}>Hospedagem da aplicação web</td>
              <td className={tableCellClass}>
                Estados Unidos / Global (CDN)
              </td>
            </tr>
            <tr>
              <td className={tableCellClass}>Resend</td>
              <td className={tableCellClass}>
                Envio transacional de e-mails (confirmações, QR Codes,
                recuperação de senha)
              </td>
              <td className={tableCellClass}>Estados Unidos</td>
            </tr>
            <tr>
              <td className={tableCellClass}>Mercado Pago</td>
              <td className={tableCellClass}>Processamento de pagamentos</td>
              <td className={tableCellClass}>Brasil</td>
            </tr>
            <tr>
              <td className={tableCellClass}>Cloudflare Turnstile</td>
              <td className={tableCellClass}>
                Proteção contra automação maliciosa no cadastro
              </td>
              <td className={tableCellClass}>Global (CDN)</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p>
        ...
        proteção de dados, conforme art. 33 da LGPD, em especial: contratos
        de processamento de dados (DPA), certificações internacionais (SOC
        2, ISO 27001) e cláusulas contratuais padrão para transferência
        internacional, quando aplicáveis.
      </p>
      ...
      <p>
        ...
        seguro, com controle de acesso, criptografia em trânsito (HTTPS/TLS)
        e em repouso, conforme padrões de mercado.
      </p>
      <p>
        <strong>5.2</strong> Os prazos de retenção observam a finalidade de
        cada tratamento:
      </p>
      ...
      <div className="not-prose my-6 overflow-x-auto">
        <table className="w-full border-collapse text-sm">
          <thead>
            <tr>
              <th className={tableHeadClass}>Categoria de dado</th>
              <th className={tableHeadClass}>Prazo de retenção</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td className={tableCellClass}>
                ...
                (cinco) anos após inatividade ou exclusão da conta, observado
                o prazo prescricional do art. 27 do CDC.
              </td>
            </tr>
            <tr>
              <td className={tableCellClass}>Histórico de compras</td>
              <td className={tableCellClass}>
                Por até 5 (cinco) anos após a data do evento correspondente,
                para fins fiscais e prescricionais.
              </td>
            </tr>
            <tr>
              <td className={tableCellClass}>Logs de acesso (IP, data/hora)</td>
              <td className={tableCellClass}>
            ...
            <tr>
              <td className={tableCellClass}>Logs de auditoria</td>
              <td className={tableCellClass}>Por até 5 (cinco) anos.</td>
            </tr>
            <tr>
              <td className={tableCellClass}>QR Codes (PNG no Storage)</td>
              <td className={tableCellClass}>
            ...
            <tr>
              <td className={tableCellClass}>Senhas</td>
              <td className={tableCellClass}>
                Armazenadas de forma criptografada (hash irreversível)
                durante todo o ciclo de vida da conta. Não são acessíveis em
                texto plano por nenhum funcionário ou sistema.
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <ul>
        ...
        <li>
          Informação sobre as entidades públicas e privadas com as quais o
        ...
        <li>
          Oposição a tratamento realizado com fundamento em hipótese diversa
      ...
      <p>
        ...
        recebimento, podendo este prazo ser prorrogado mediante
        justificativa, conforme art. 19, § 1º, da LGPD.
      </p>
      <p>
        <strong>6.3</strong> Para garantia da segurança dos dados, o
        Controlador poderá solicitar comprovação adicional da identidade do
        titular antes de atender a solicitação.
      </p>
      <p>
        <strong>6.4</strong> A eliminação total dos dados pode implicar a
        impossibilidade de continuidade da prestação dos serviços, hipótese
        em que o titular será informado previamente.
      </p>

      <h2>7. Segurança da Informação</h2>
      <p>
        <strong>7.1</strong> O Controlador e a Plataforma adotam medidas
        técnicas e administrativas razoáveis para proteger os dados pessoais
        contra acesso não autorizado, perda, destruição, alteração ou
      ...
      <ul>
        ...
        <li>
          Controle de acesso baseado em níveis de permissão (administrador,
          produtor, cliente)
        </li>
        <li>
          Validação de assinatura HMAC-SHA256 em comunicações de webhook do
      ...
      <p>
        <strong>7.2</strong> Apesar das medidas adotadas, nenhum sistema de
        informação é absolutamente imune a falhas. Em caso de incidente de
        segurança que possa acarretar risco ou dano relevante aos titulares,
        o Controlador comunicará o incidente à Autoridade Nacional de
        Proteção de Dados (ANPD) e aos titulares afetados, conforme art. 48
        da LGPD.
      </p>
      ...
      <p>
        ...
        terceiros para fins publicitários ou de rastreamento de comportamento
      ...
      <p>
        ...
        maiores de 18 (dezoito) anos. Não é permitido o cadastro por menores
        de idade.
      </p>
      <p>
      ...
      <p>
        <strong>11.1</strong> Para qualquer dúvida, solicitação ou reclamação
        relativa a dados pessoais, o titular pode entrar em contato:
      </p>
      <p>
      ...
      <p>
        <strong>11.2</strong> O titular também pode peticionar diretamente à
        Autoridade Nacional de Proteção de Dados (ANPD), por meio dos canais
        oficiais disponíveis em{' '}
        <a
      ...
      <p>
        <strong>12.1</strong> Esta Política é regida pelas leis da República
        Federativa do Brasil, em especial a LGPD, o Marco Civil da Internet
        e o Código de Defesa do Consumidor.
      </p>
      <p>
        <strong>12.2</strong> Fica eleito o foro da comarca de domicílio do
        titular para dirimir quaisquer questões relacionadas a esta Política,
        em conformidade com o artigo 101, inciso I, do Código de Defesa do
        Consumidor.
      </p>
    </div>
  );
