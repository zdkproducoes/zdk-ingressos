...
<h1 style="margin:0;font-size:28px;font-weight:800;color:#EADBC4;letter-spacing:-0.5px;">${escape(platform.name)}</h1>
</td></tr>
<tr><td style="padding:40px;">
<h2 style="margin:0 0 16px;font-size:22px;font-weight:700;color:#EADBC4;">Olá, ${escape(firstName)}! 👋</h2>
<p style="margin:0 0 24px;font-size:16px;line-height:1.6;color:#D9C2A0;">Recebemos seu cadastro na plataforma ${escape(platform.name)}. Para concluir, confirme seu e-mail clicando no botão abaixo:</p>
...
<p style="margin:0;font-size:12px;color:#BFA279;">© ${new Date().getFullYear()} ${escape(platform.name)} — Plataforma de Ingressos</p>
